# Note
This project's frontend is under development and will be completed in 1-2 days(Hopefully). Rest everything is complete. If you want to understand the project, below is the whole mechanism how this project works.
