...
export class zkMP__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class zkMP extends ethereum.SmartContract {
  static bind(address: Address): zkMP {
    return new zkMP("zkMP", address);
  }
  ...
  getListing(
    ...
    return changetype<zkMP__getListingResultValue0Struct>(result[0].toTuple());
  }
  ...
  try_getListing(
    ...
    return ethereum.CallResult.fromValue(
      changetype<zkMP__getListingResultValue0Struct>(value[0].toTuple())
    );
  }
